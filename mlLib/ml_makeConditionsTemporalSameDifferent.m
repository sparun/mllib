% MAKE CONDITIONS TEMPORAL SAME-DIFFERENT - NIMH MonkeyLogic - Vision Lab, IISc
% ----------------------------------------------------------------------------------------
...
% Temporal Same-Different experiment.
%
% INPUTS
%   timingFileName      - the name of the timing file (without file extension).
%   conditionsFileName  - the name of the conditions file (without TSD-prefix or file extension).
%   stPairs             - nTrials x 2 (sample, test) - file names (without file extension)
...
sampleImage     = sprintf('pic(%s, 0, 0)', stPairs{1,1});
testImage       = sprintf('pic(%s, 0, 0)', stPairs{1,2});
...
for trialID = 1:length(stPairs)
    % VARIBLE TaskObjects for Same-Different trials (10 and 11)
    sampleImage     = sprintf('pic(%s, 0, 0)', stPairs{trialID,1});
    testImage       = sprintf('pic(%s, 0, 0)', stPairs{trialID,2});
